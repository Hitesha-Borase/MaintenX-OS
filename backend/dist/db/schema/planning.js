...
exports.forecasts = (0, pg_core_1.pgTable)("forecasts", {
    ...
    owner: (0, pg_core_1.varchar)("owner", { length: 255 }).default("Ronald Robinson"),
...
exports.pmScheduleVersions = (0, pg_core_1.pgTable)("pm_schedule_versions", {
    ...
    createdBy: (0, pg_core_1.varchar)("created_by", { length: 255 }).default("Stefan Crawford (Plant Manager)"),
