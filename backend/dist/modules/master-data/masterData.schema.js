...
exports.createRoutingSchema = zod_1.z.object({
    routingCode: zod_1.z.string().optional().nullable(),
    skuId: zod_1.z.string().optional().nullable(),
    lineId: zod_1.z.string().optional().nullable(),
    plantId: zod_1.z.string().optional().nullable(),
    revision: zod_1.z.string().default("R1"),
    approvalStatus: zod_1.z.string().default("Approved"),
