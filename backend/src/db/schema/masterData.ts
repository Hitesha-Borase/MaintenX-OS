...
export const boms = pgTable("boms", {
  ...
  createdBy: varchar("created_by", { length: 100 }).default("Ronald Robinson"),
  createdAt: timestamp("created_at").defaultNow().notNull(),
  updatedAt: timestamp("updated_at").defaultNow().notNull(),
});
...
export const employeeSkills = pgTable("employee_skills", {
  ...
  plantId: varchar("plant_id", { length: 50 }).default("PLT-01"),
  plantName: varchar("plant_name", { length: 150 }).default("Plant 1 - Meat Processing & Smokehouse Facility"),
