...
export const capaRecords = pgTable("capa_records", {
  ...
  assignedToName: varchar("assigned_to_name", { length: 150 }).default("Stephanie Kuzmych"),
...
export const cleaningVerifications = pgTable("cleaning_verifications", {
  ...
  verifiedBy: varchar("verified_by", { length: 150 }).default("Stephanie Kuzmych"),
...
export const ncrs = pgTable("ncrs", {
  ...
  reportedBy: varchar("reported_by", { length: 150 }).default("Stephanie Kuzmych"),
  date: varchar("date", { length: 50 }),
  createdAt: timestamp("created_at", { withTimezone: true }).defaultNow().notNull(),
  updatedAt: timestamp("updated_at", { withTimezone: true }).defaultNow().notNull(),
});
...
export const qualityInvestigations = pgTable("quality_investigations", {
  ...
  leadInvestigator: varchar("lead_investigator", { length: 150 }).default("Stephanie Kuzmych"),
  targetDate: varchar("target_date", { length: 50 }),
...
export const batchHistory = pgTable("batch_history", {
  ...
  auditor: varchar("auditor", { length: 150 }).default("Stephanie Kuzmych"),
  createdAt: timestamp("created_at", { withTimezone: true }).defaultNow().notNull(),
  updatedAt: timestamp("updated_at", { withTimezone: true }).defaultNow().notNull(),
});
...
export const batchQualityRecords = pgTable("batch_quality_records", {
  ...
  date: varchar("date", { length: 50 }).notNull(),
  officer: varchar("officer", { length: 150 }).default("Stephanie Kuzmych"),
...
export const qaDispositionRecords = pgTable("qa_disposition_records", {
  ...
  authorizedBy: varchar("authorized_by", { length: 150 }).default("Stephanie Kuzmych (QA Manager & HACCP Lead)"),
...
export const qaProfiles = pgTable("qa_profiles", {
  id: serial("id").primaryKey(),
  tenantId: uuid("tenant_id").references(() => tenants.id, { onDelete: "cascade" }),
  name: varchar("name", { length: 150 }).default("Stephanie Kuzmych"),
