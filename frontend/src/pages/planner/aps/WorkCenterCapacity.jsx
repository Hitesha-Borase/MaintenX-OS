...
export function WorkCenterCapacity() {
  ...
  const activeWorkCenters = apiWorkCenters || capacityCalculations.map((c) => ({
    ...
    lineCode: c.lineCode,
    name: c.name,
    plantFacility: c.plantName || "Plant 1 - Meat Processing & Smokehouse Facility",
    ratedCapacity: c.runRateSpec || "2,500 LBS/HR",
    assignedAssetsCount: 4,
    assetDescription: "Machines (Smokehouse, Grinder, Slicer, Metal Detector)",
