...
export function Reports() {
  ...
  const reports = [
    ...
    {
      id: "SUP-02",
      name: "Allergen Sanitation Clean Log",
      category: "Sanitation",
      date: "2026-08-31",
      cadence: "Daily",
      format: "PDF / Audit Log"
    },
    {
      id: "SUP-03",
      name: "CCP Parameter Compliance Audit",
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "20px", width: "100%", maxWidth: "1200px", margin: "0 auto", minWidth: 0 }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: "12px", width: "100%" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "8px", flexWrap: "wrap" }}>
          ...
          <Button variant="primary" icon={ArrowRight} onClick={() => navigate("/supervisor/notifications")} style={{ fontSize: "12px", padding: "7px 12px" }}>
            Notifications
          </Button>
        </div>
      </div>
