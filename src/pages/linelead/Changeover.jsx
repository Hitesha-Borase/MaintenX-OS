...
import { Shuffle, Clock, CheckCircle2, Play, Check } from "lucide-react";
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "20px", maxWidth: "800px" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "10px" }}>
        <div>
          ...
          <p style={{ fontSize: "12px", color: "var(--text-secondary)", marginTop: "2px" }}>
            Steer flavor and package size modifications for aseptic filling
          </p>
        </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "16px" }}>
        <Card style={{ borderLeft: "3px solid #38BDF8" }}>
          ...
          <div style={{ fontSize: "15px", fontWeight: 800, color: "#FFFFFF", marginTop: "4px" }}>SKU-AJ-500ML-ORG</div>
        ...
        <Card style={{ borderLeft: "3px solid #A855F7" }}>
          ...
          <div style={{ fontSize: "15px", fontWeight: 800, color: "#FFFFFF", marginTop: "4px" }}>SKU-AJ-1L-ORG</div>
            ...
            return (
              ...
              >
                <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                  ...
                  <div>
                    <span style={{ fontSize: "13px", fontWeight: 600, color: isCompleted ? "var(--text-muted)" : "#FFFFFF", textDecoration: isCompleted ? "line-through" : "none" }}>
                      {step.name}
                    </span>
