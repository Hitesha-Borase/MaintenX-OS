...
export function Notifications() {
  ...
  const [notifications, setNotifications] = useState([
    { id: 1, type: "mrp", icon: ShieldAlert, title: "Material Stockout Risk", msg: "Aseptic orange caps safety stock level projected to violate Safety Buffer in Week 2.", time: "10 min ago", path: "/planner/mrp/shortages" },
    { id: 2, type: "schedule", icon: Info, title: "Schedule Feasibility Feasible", msg: "Model sequence checks completed for version V4.2.", time: "1 hour ago", path: "/planner/aps/validation" }
  ]);
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "20px", maxWidth: "800px" }}>
      <div>
        <h1 style={{ fontSize: "20px", fontWeight: 800, color: "var(--text-primary)" }}>
          Supply Planning Dispatch Alerts
        </h1>
