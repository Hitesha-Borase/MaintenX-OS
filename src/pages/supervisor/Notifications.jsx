...
export function Notifications() {
  ...
  const [notifications, setNotifications] = useState([
    { id: 1, type: "system", read: false, icon: Info, title: "Pending PM Audit", msg: "Sanitation check signed off by operator. Requires supervisor sign-off.", time: "10 min ago", path: "/supervisor/approvals" },
  ...
  const getStyleProps = (type) => {
    switch (type) {
      case "system":
        return { border: "#10B981", bg: "rgba(16, 185, 129, 0.1)", color: "#10B981", badge: "AUDIT REQUIRED", badgeVariant: "emerald" };
      case "exception":
        return { border: "#EF4444", bg: "rgba(239, 68, 68, 0.1)", color: "#EF4444", badge: "EXCEPTION", badgeVariant: "red" };
      default:
