...
export function Notifications() {
  ...
  const [notifications, setNotifications] = useState([
    { id: 1, type: "receiving", icon: Info, title: "Carrier Arrived at Dock 4", msg: "Lot delivery of ADM Cane Sugar arrived. Awaiting staging sign-off.", time: "5 min ago", path: "/warehouse/receiving/receive" },
    { id: 2, type: "picking", icon: ShieldAlert, title: "Urgent Staging Pick Required", msg: "Line 1 Aseptic run requires 1,500 Orange Caps stage pick.", time: "15 min ago", path: "/warehouse/picking/execution" }
  ]);
